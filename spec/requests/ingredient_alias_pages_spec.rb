...
describe "IngredientAlias pages" do
  before do
  ...
  describe "list ingredient alias" do
    before do
      visit_page("#{ingredient_aliases_path}?per_page=4", @user)
    end

    describe "should have a list" do
      it { should have_selector("h1", text: "Ingredient Aliases") }
